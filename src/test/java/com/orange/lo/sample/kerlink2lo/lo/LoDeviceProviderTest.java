...
class LoDeviceProviderTest {
    ...
    void setUp() {
        ...
        when(inventory.getDevices(any(GetDevicesFilter.class))).thenAnswer(LoDeviceProviderTest::getObjects);
    ...
    void shouldGetOneDeviceWhenGroupWithOneDeviceAndNoSubgroupsIsUsed() {
        List<Device> devices = loDeviceProvider.getDevices("device_group2_sub2_sub");
    ...
    void shouldGetWholeDevicesFromSelectedGroupAndSubgroupsWhenGroupWithSubgroupsIsUsed() {
        List<Device> devices = loDeviceProvider.getDevices("device_group2");
    ...
    void shouldGetWholeDevicesFromWholeGroupsWhenRootGroupIsUsed() {
        List<Device> devices = loDeviceProvider.getDevices("root");
    ...
    void shouldGetWholeDevicesFromWholeGroupsWhenNonExistentGroupIsUsed2() {
        List<Device> devices = loDeviceProvider.getDevices("NonExistentGroup");
    ...
    void shouldAddMonitoringPartForProdEnvironment(String group, int numberOfGroupApiCalls, int numberOfInventoryApiCalls) {
        loDeviceProvider.getDevices(group);
